  ...
  return (  
    <div>
        ...
        <div className="coming_Container">
          ...
          <Link to="/event_upcoming"><button className="eventBtn1"><b>Upcoming Events</b></button></Link>
          <Link to="/event_past"><button className="eventBtn2"><b>Past Events</b></button></Link>
        </div>
